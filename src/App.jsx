...
const TOILET_DB = {
  "서울역_1": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실 내 우측", other_lines: [{ line: "4", direction: "4호선 구역으로 이동 후 대합실 화장실 이용" }] },
  "시청_1": { gate_in: false, gate_out: true, gate_out_location: "7번 출구 방향 대합실 좌측", other_lines: [{ line: "2", direction: "2호선 개찰구 방향 이동 — 개찰구 안 화장실 있음" }] },
  "종각_1": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실 내" },
  "종로3가_1": { gate_in: true, gate_in_location: "3호선·5호선 환승통로 중간 우측", gate_out: true, gate_out_location: "5번 출구 방향 대합실", other_lines: [{ line: "3", direction: "3호선 환승통로 진입 후 우측 화장실" }, { line: "5", direction: "5호선 환승통로 진입 후 좌측 화장실" }] },
  "동대문_1": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "4", direction: "4호선 구역 대합실 화장실 이용 가능" }] },
  "신도림_1": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실 우측", other_lines: [{ line: "2", direction: "2호선 구역 — 개찰구 안 화장실 있음" }] },
  "구로_1": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "구일_1": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 나와서 우측 50m 공중화장실" },
  "가산디지털단지_1": { gate_in: false, gate_out: true, gate_out_location: "4번 출구 방향 대합실 내", other_lines: [{ line: "7", direction: "7호선 구역 대합실 화장실 이용 가능" }] },

  "시청_2": { gate_in: true, gate_in_location: "승강장 2-3 칸 사이 계단 올라와서 좌측", gate_out: false, other_lines: [{ line: "1", direction: "1호선 구역 대합실 화장실 이용 가능" }] },
  "홍대입구_2": { gate_in: true, gate_in_location: "승강장 끝 (신촌 방향) 계단 위 대합실", gate_out: true, gate_out_location: "9번 출구 방향 대합실 우측" },
  "합정_2": { gate_in: true, gate_in_location: "대합실 개찰구 통과 후 우측", gate_out: false, other_lines: [{ line: "6", direction: "6호선 환승통로 이동 후 대합실 화장실" }] },
  "신도림_2": { gate_in: true, gate_in_location: "1·2호선 환승 통로 내 우측", gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "신림_2": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실 내 좌측" },
  "서울대입구_2": { gate_in: true, gate_in_location: "개찰구 통과 후 승강장 방향 우측", gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "낙성대_2": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실 내" },
  "사당_2": { gate_in: true, gate_in_location: "4호선 환승통로 방향 대합실 내", gate_out: true, gate_out_location: "4번 출구 방향 대합실 우측", other_lines: [{ line: "4", direction: "4호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "교대_2": { gate_in: true, gate_in_location: "3호선 환승통로 중간 좌측", gate_out: true, gate_out_location: "10번 출구 방향 대합실", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 후 화장실" }] },
  "강남_2": { gate_in: true, gate_in_location: "승강장 중간 계단 위 대합실 좌측", gate_out: true, gate_out_location: "11번 출구 방향 대합실 내" },
  "역삼_2": { gate_in: false, gate_out: true, gate_out_location: "4번 출구 방향 대합실 내" },
  "선릉_2": { gate_in: true, gate_in_location: "수인분당선 환승통로 방향 대합실", gate_out: false, other_lines: [{ line: "수인분당", direction: "수인분당선 환승통로 이동 후 화장실" }] },
  "삼성_2": { gate_in: true, gate_in_location: "승강장 3-4 칸 계단 위 우측", gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "종합운동장_2": { gate_in: true, gate_in_location: "개찰구 통과 직후 우측", gate_out: false },
  "잠실_2": { gate_in: true, gate_in_location: "8호선 환승통로 방향 대합실 내", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "8", direction: "8호선 환승통로 진입 후 우측" }] },
  "건대입구_2": { gate_in: true, gate_in_location: "7호선 환승통로 중간 좌측", gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "7", direction: "7호선 환승통로 이동 후 화장실" }] },
  "왕십리_2": { gate_in: true, gate_in_location: "5호선·경의중앙선 환승 대합실 내", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 후 화장실" }, { line: "경의중앙", direction: "경의중앙선 환승통로 이동 후 화장실" }] },
  "신촌_2": { gate_in: true, gate_in_location: "개찰구 통과 후 승강장 방향 좌측", gate_out: true, gate_out_location: "3번 출구 방향 대합실" },
  "이대_2": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실 내" },
  "충정로_2": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 후 화장실" }] },
  "잠실나루_2": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "강변_2": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실 내" },
  "성수_2": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실" },
  "한양대_2": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실 내" },
  "뚝섬_2": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },

  "연신내_3": { gate_in: true, gate_in_location: "6호선 환승통로 방향 대합실 내", gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "6", direction: "6호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "종로3가_3": { gate_in: true, gate_in_location: "1호선·5호선 환승통로 중간", gate_out: true, gate_out_location: "5번 출구 방향 대합실" },
  "충무로_3": { gate_in: true, gate_in_location: "4호선 환승통로 진입 후 우측", gate_out: false, other_lines: [{ line: "4", direction: "4호선 환승통로 이동 후 화장실" }] },
  "고속터미널_3": { gate_in: true, gate_in_location: "7호선 환승통로 방향 대합실", gate_out: true, gate_out_location: "8번 출구 방향 고속터미널 내 화장실", other_lines: [{ line: "7", direction: "7호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "9", direction: "9호선 환승통로 이동 후 화장실" }] },
  "교대_3": { gate_in: true, gate_in_location: "2호선 환승통로 중간 우측", gate_out: true, gate_out_location: "10번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "양재_3": { gate_in: true, gate_in_location: "개찰구 통과 후 좌측", gate_out: true, gate_out_location: "4번 출구 방향 대합실 우측", other_lines: [{ line: "신분당", direction: "신분당선 환승통로 이동 후 화장실" }] },
  "약수_3": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "6", direction: "6호선 환승통로 이동 후 화장실" }] },
  "옥수_3": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실 내", other_lines: [{ line: "경의중앙", direction: "경의중앙선 환승통로 이동 후 화장실" }] },

  "동대문역사문화공원_4": { gate_in: true, gate_in_location: "2호선·5호선 환승통로 대합실 내", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 후 화장실" }, { line: "5", direction: "5호선 환승통로 이동 후 화장실" }] },
  "동대문_4": { gate_in: true, gate_in_location: "1호선 환승통로 중간 좌측", gate_out: true, gate_out_location: "8번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },
  "명동_4": { gate_in: true, gate_in_location: "개찰구 통과 후 승강장 방향 우측", gate_out: false },
  "충무로_4": { gate_in: true, gate_in_location: "3호선 환승통로 방향 대합실", gate_out: false, other_lines: [{ line: "3", direction: "3호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "사당_4": { gate_in: true, gate_in_location: "2호선 환승통로 방향 대합실", gate_out: true, gate_out_location: "4번 출구 방향 대합실 우측", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "노원_4": { gate_in: true, gate_in_location: "7호선 환승통로 중간 우측", gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "7", direction: "7호선 환승통로 이동 후 화장실" }] },
  "수유_4": { gate_in: true, gate_in_location: "개찰구 통과 후 좌측", gate_out: true, gate_out_location: "1번 출구 방향 대합실 내" },
  "서울역_4": { gate_in: false, gate_out: true, gate_out_location: "4번 출구 방향 대합실 내", other_lines: [{ line: "1", direction: "1호선 구역 대합실 화장실 이용 가능" }] },

  "광화문_5": { gate_in: true, gate_in_location: "개찰구 통과 후 승강장 방향 우측", gate_out: false },
  "여의도_5": { gate_in: true, gate_in_location: "9호선 환승통로 방향 대합실 내", gate_out: true, gate_out_location: "5번 출구 방향 대합실", other_lines: [{ line: "9", direction: "9호선 환승통로 이동 후 화장실" }] },
  "공덕_5": { gate_in: true, gate_in_location: "6호선·경의중앙선 환승통로 내", gate_out: true, gate_out_location: "7번 출구 방향 대합실", other_lines: [{ line: "6", direction: "6호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "경의중앙", direction: "경의중앙선 환승통로 이동 후 화장실" }] },
  "종로3가_5": { gate_in: true, gate_in_location: "1호선·3호선 환승통로 방향 우측", gate_out: false, other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }, { line: "3", direction: "3호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "동대문역사문화공원_5": { gate_in: true, gate_in_location: "2호선·4호선 환승통로 대합실", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 후 화장실" }, { line: "4", direction: "4호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "왕십리_5": { gate_in: true, gate_in_location: "2호선·경의중앙선 환승 대합실", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "천호_5": { gate_in: true, gate_in_location: "8호선 환승통로 방향 대합실 내", gate_out: true, gate_out_location: "6번 출구 방향 대합실", other_lines: [{ line: "8", direction: "8호선 환승통로 이동 후 화장실" }] },
  "김포공항_5": { gate_in: true, gate_in_location: "9호선·공항철도 환승통로 대합실", gate_out: true, gate_out_location: "4번 출구 방향 대합실 내", other_lines: [{ line: "9", direction: "9호선 환승통로 이동 후 화장실" }] },
  "충정로_5": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 후 화장실" }] },

  "합정_6": { gate_in: true, gate_in_location: "2호선 환승통로 방향 대합실", gate_out: false, other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "공덕_6": { gate_in: true, gate_in_location: "5호선·경의중앙선 환승통로 내", gate_out: true, gate_out_location: "7번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "연신내_6": { gate_in: true, gate_in_location: "3호선 환승통로 방향 대합실 내", gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "동묘앞_6": { gate_in: true, gate_in_location: "승강장 내 화장실 (1호선 환승통로 방향)", gate_out: false, other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },
  "약수_6": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 후 화장실" }] },

  "노원_7": { gate_in: true, gate_in_location: "4호선 환승통로 중간 우측", gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "4", direction: "4호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "건대입구_7": { gate_in: true, gate_in_location: "2호선 환승통로 방향 대합실", gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "고속터미널_7": { gate_in: true, gate_in_location: "3호선·9호선 환승통로 내", gate_out: true, gate_out_location: "8-1번 출구 방향 터미널 내 화장실", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "9", direction: "9호선 환승통로 이동 후 화장실" }] },
  "이수_7": { gate_in: false, gate_out: true, gate_out_location: "7번 출구 방향 대합실 내", other_lines: [{ line: "4", direction: "4호선(총신대입구) 환승통로 이동 후 화장실" }] },
  "가산디지털단지_7": { gate_in: false, gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },

  "잠실_8": { gate_in: true, gate_in_location: "2호선 환승통로 방향 대합실", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "천호_8": { gate_in: true, gate_in_location: "5호선 환승통로 방향 대합실", gate_out: true, gate_out_location: "6번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "가락시장_8": { gate_in: false, gate_out: true, gate_out_location: "5번 출구 방향 대합실 내", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 후 화장실" }] },
  "모란_8": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실 내" },

  // ── 9호선 ──
  "개화_9": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "김포공항_9": { gate_in: true, gate_in_location: "5·공항철도 환승통로 대합실", gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 후 화장실" }, { line: "공항철도", direction: "공항철도 환승통로 이동 후 화장실" }] },
  "가양_9": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실" },
  "당산_9": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 후 화장실" }] },
  "여의도_9": { gate_in: true, gate_in_location: "5호선 환승통로 방향 대합실", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "노량진_9": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },
  "동작_9": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "4", direction: "4호선 환승통로 이동 후 화장실" }] },
  "고속터미널_9": { gate_in: true, gate_in_location: "3·7호선 환승통로 대합실", gate_out: true, gate_out_location: "8-1번 출구 방향 터미널 내", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "7", direction: "7호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "신논현_9": { gate_in: false, gate_out: true, gate_out_location: "5번 출구 방향 대합실", other_lines: [{ line: "신분당", direction: "신분당선 환승통로 이동 후 화장실" }] },
  "언주_9": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "선정릉_9": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "수인분당", direction: "수인분당선 환승통로 이동 후 화장실" }] },
  "종합운동장_9": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 — 개찰구 안 화장실 있음" }] },
  "석촌_9": { gate_in: false, gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "8", direction: "8호선 환승통로 이동 후 화장실" }] },
  "올림픽공원_9": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "중앙보훈병원_9": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },

  // ── 수인·분당선 ──
  "수원_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },
  "인천_수인분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "한대앞_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "4", direction: "4호선 환승통로 이동 후 화장실" }] },
  "오이도_수인분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "4", direction: "4호선 환승통로 이동 후 화장실" }] },
  "사당_수인분당": { gate_in: false, gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 후 화장실" }, { line: "4", direction: "4호선 환승통로 이동 후 화장실" }] },
  "선릉_수인분당": { gate_in: true, gate_in_location: "2호선 환승통로 방향 대합실", gate_out: false, other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "수서_수인분당": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 후 화장실" }] },
  "복정_수인분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "8", direction: "8호선 환승통로 이동 후 화장실" }] },
  "모란_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "8", direction: "8호선 환승통로 이동 후 화장실" }] },
  "정자_수인분당": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "신분당", direction: "신분당선 환승통로 이동 후 화장실" }] },
  "미금_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "신분당", direction: "신분당선 환승통로 이동 후 화장실" }] },
  "야탑_수인분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "서현_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "수내_수인분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "죽전_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "기흥_수인분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "영통_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "압구정로데오_수인분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "강남구청_수인분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "7", direction: "7호선 환승통로 이동 후 화장실" }] },

  // ── 신분당선 ──
  "신사_신분당": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실" },
  "강남_신분당": { gate_in: true, gate_in_location: "2호선 환승통로 방향 대합실", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "양재_신분당": { gate_in: true, gate_in_location: "개찰구 통과 후 좌측", gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "판교_신분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "정자_신분당": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "수인분당", direction: "수인분당선 환승통로 이동 후 화장실" }] },
  "미금_신분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "수인분당", direction: "수인분당선 환승통로 이동 후 화장실" }] },
  "동천_신분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "수지구청_신분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "광교중앙_신분당": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "광교_신분당": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },

  // ── 경의·중앙선 ──
  "서울역_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 구역 화장실 이용 가능" }, { line: "4", direction: "4호선 구역 화장실 이용 가능" }] },
  "공덕_경의중앙": { gate_in: true, gate_in_location: "5·6호선 환승통로 대합실", gate_out: true, gate_out_location: "7번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "6", direction: "6호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "홍대입구_경의중앙": { gate_in: true, gate_in_location: "2호선·공항철도 환승통로 대합실", gate_out: true, gate_out_location: "9번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "공항철도", direction: "공항철도 환승통로 이동 후 화장실" }] },
  "왕십리_경의중앙": { gate_in: true, gate_in_location: "2호선·5호선 환승 대합실", gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "5", direction: "5호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "옥수_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 후 화장실" }] },
  "청량리_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },
  "회기_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },
  "용산_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }] },
  "수색_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "능곡_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  "일산_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실" },
  "금촌_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "문산_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "양평_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "용문_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "디지털미디어시티_경의중앙": { gate_in: false, gate_out: true, gate_out_location: "3번 출구 방향 대합실", other_lines: [{ line: "6", direction: "6호선 환승통로 이동 후 화장실" }, { line: "공항철도", direction: "공항철도 환승통로 이동 후 화장실" }] },

  // ── 공항철도 ──
  "서울역_공항철도": { gate_in: false, gate_out: true, gate_out_location: "공항철도 대합실 내 우측", other_lines: [{ line: "1", direction: "1호선 구역 화장실 이용 가능" }, { line: "4", direction: "4호선 구역 화장실 이용 가능" }] },
  "홍대입구_공항철도": { gate_in: true, gate_in_location: "2호선·경의중앙선 환승통로 대합실", gate_out: true, gate_out_location: "9번 출구 방향 대합실", other_lines: [{ line: "2", direction: "2호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "공덕_공항철도": { gate_in: true, gate_in_location: "5·6호선 환승통로 대합실", gate_out: true, gate_out_location: "7번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 — 개찰구 안 화장실 있음" }] },
  "김포공항_공항철도": { gate_in: true, gate_in_location: "5·9호선 환승통로 대합실", gate_out: true, gate_out_location: "4번 출구 방향 대합실", other_lines: [{ line: "5", direction: "5호선 환승통로 이동 — 개찰구 안 화장실 있음" }, { line: "9", direction: "9호선 환승통로 이동 후 화장실" }] },
  "계양_공항철도": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },
  "검암_공항철도": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실" },
  ...
  // ── 우이신설선 ──
  "신설동_우이신설": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "1", direction: "1호선 환승통로 이동 후 화장실" }, { line: "2", direction: "2호선 환승통로 이동 후 화장실" }] },
  "보문_우이신설": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실", other_lines: [{ line: "6", direction: "6호선 환승통로 이동 후 화장실" }] },
  "성신여대입구_우이신설": { gate_in: false, gate_out: true, gate_out_location: "2번 출구 방향 대합실", other_lines: [{ line: "4", direction: "4호선 환승통로 이동 후 화장실" }] },
  "북한산우이_우이신설": { gate_in: false, gate_out: true, gate_out_location: "1번 출구 방향 대합실" },

  // ── GTX-A ──
  "수서_GTX-A": { gate_in: false, gate_out: true, gate_out_location: "대합실 내 우측", other_lines: [{ line: "3", direction: "3호선 환승통로 이동 후 화장실" }, { line: "수인분당", direction: "수인분당선 환승통로 이동 후 화장실" }] },
  "성남_GTX-A": { gate_in: false, gate_out: true, gate_out_location: "대합실 내" },
  "동탄_GTX-A": { gate_in: false, gate_out: true, gate_out_location: "대합실 내" },
};
