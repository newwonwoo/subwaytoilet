...
const TOILET_DB = {
  ...
  "노량진_1": {toilets:[{gate:"내부",exit:"2",location:"2번출구 표 내는 곳 앞"}]},
  ...
  "도봉산_1": {toilets:[{gate:"외부",exit:"1",location:"(2F) 맞이방 앞 1 3번 출입구 방향"}]},
  ...
  "서울역_1": {toilets:[{gate:"외부",exit:"2",location:"지하1층 2번출입구 부근"}]},
  ...
  "신도림_1": {toilets:[{gate:"외부",exit:"4 5 6",location:"2층 대합실"}]},
  ...
  "강남_2": {toilets:[{gate:"내부",exit:"12",location:"대합실 1층 역무실쪽(1 12번출입구쪽) 표 내는 곳 내부"}]},
  "강변_2": {toilets:[{gate:"외부",exit:"2",location:"대합실 1층 통로 중앙"}]},
  "건대입구_2": {toilets:[{gate:"내부",exit:"2",location:"대합실 2층 통로 중앙"}]},
  "교대_2": {toilets:[{gate:"외부",exit:"4",location:"대합실 1층 1 2 3 4 번출입구 쪽"}]},
  ...
  "당산_2": {toilets:[{gate:"내부",exit:"4",location:"지상2층 대합실 중앙(표 내는 곳 내부)"}]},
  ...
  "사당_2": {toilets:[{gate:"외부",exit:"1",location:"지하1층 대합실 1 2번 출입구 쪽(방배측)"},{gate:"외부",exit:"7",location:"지하1층 대합실 7 8번 출입구 쪽(낙성대측)"}]},
  ...
  "신림_2": {toilets:[{gate:"내부",exit:"4",location:"대합실 1층 역무실 맞은편(3 4번출입구쪽) 표 내는 곳 내부"}]},
  ...
  "왕십리_2": {toilets:[{gate:"외부",exit:"6-1",location:"지하1층 6-1번 출입구 쪽"}]},
  ...
  "잠실_2": {toilets:[{gate:"외부",exit:"1",location:"대합실 1층 1 2번출입구 앞"}]},
  ...
  "합정_2": {toilets:[{gate:"내부",exit:"1",location:"지하1층대합실 1 2번출입구"}]},
  "홍대입구_2": {toilets:[{gate:"외부",exit:"2",location:"지하1층대합실 2번출입구 옆"}]},
  ...
  "교대_3": {toilets:[{gate:"외부",exit:"12",location:"대합실1층 역무실 맞은편 표 내는 곳 외부"}]},
  ...
  "초지_4": {toilets:[{gate:"내부",exit:"1",location:"(1F) 맞이방 표 내는 곳 안쪽 계단통로 가운데"}]},
  "총신대입구_4": {toilets:[{gate:"내부",exit:"1",location:"지하1층 동작측"}]},
  "충무로_4": {toilets:[{gate:"내부",exit:"3",location:"지하2층 3 4 5 6 7번 출입구쪽 표 내는 곳 내부"}]},
  ...
  "광화문_5": {toilets:[{gate:"외부",exit:"7 8",location:"세종측 대합실 지하1층"},{gate:"외부",exit:"7 또는8",location:"세종측 대합실 지하1층"}]},
  ...
  "신정_5": {toilets:[{gate:"외부",exit:"2 3",location:"2 3번 출입구 지하 (가)대합실 운임지역 내"},{gate:"외부",exit:"2 또는3",location:"2,3번 출구 지하 (가)대합실 운임지역 내"}]},
  ...
  "고속터미널_7": {toilets:[{gate:"외부",exit:"3",location:"대합실 1층 3번출입구 왼쪽"}]},
  ...
  "온수_7": {toilets:[{gate:"외부",exit:"4",location:"대합실 1층 4번출입구 방향"}]},
  ...
  "석촌_8": {toilets:[{gate:"외부",exit:"7",location:"대합실 B1층 표 내는 곳 옆"},{gate:"외부",exit:"7 또는8",location:"대합실 B1층 게이트 옆"}]},
...
const LINE_STATIONS = {
  "1": ["소요산","연천","전곡","청산","동두천","보산","동두천중앙","지행","덕정","덕계","양주","녹양","가능","의정부","회룡","망월사","도봉산","도봉","방학","창동","녹천","월계","광운대","석계","신이문","외대앞","회기","청량리","제기동","신설동","동묘앞","동대문","종로5가","종로3가","종각","시청","서울역","남영","용산","노량진","대방","신길","영등포","신도림","구로","구일","개봉","오류동","온수","역곡","소사","부천","중동","송내","부개","부평","백운","동암","간석","주안","도화","제물포","도원","동인천","인천","가산디지털단지","독산","금천구청","석수","관악","안양","명학","금정","군포","당정","의왕","성균관대","화서","수원","세류","병점","세마","오산대","오산","진위","송탄","서정리","지제","평택","성환","직산","두정","천안","봉명","쌍용","아산","배방","온양온천","신창","서동탄","탕정","광명"],
  ...
  "7": ["장암","도봉산","수락산","마들","노원","중계","하계","공릉","태릉입구","먹골","중화","상봉","면목","사가정","용마산","중곡","군자","어린이대공원","건대입구","뚝섬유원지","청담","강남구청","학동","논현","반포","고속터미널","내방","이수","남성","숭실대입구","상도","장승배기","신풍","보라매","신대방삼거리","가산디지털단지","남구로","대림","온수","천왕","광명사거리","철산","부평구청","굴포천","삼산체육관","상동","부천시청","신중동","부천종합운동장","춘의"],
  "8": ["별내","다산","암사역사공원역","암사","천호","강동구청","몽촌토성","잠실","석촌","송파","가락시장","문정","장지","복정","산성","남위례","모란","수진","신흥","단대오거리","남한산성입구"],
  "9": ["개화","신방화","마곡나루","양천향교","가양","증미","등촌","염창","신목동","선유도","당산","국회의사당","여의도","샛강","노들","노량진","흑석","동작","구반포","신반포","고속터미널","사평","신논현","언주","선정릉","삼성중앙","봉은사","종합운동장","삼전","석촌고분","석촌","송파나루","한성백제","올림픽공원","둔촌오륜","중앙보훈병원"],
  "수인분당": ["왕십리","서울숲","압구정로데오","강남구청","선정릉","선릉","한티","도곡","구룡","개포동","대모산입구","수서","복정","모란","태평","신흥","수진","단대오거리","신구대","경원대","야탑","이매","서현","수내","정자","미금","오리","죽전","보정","구성","신갈","기흥","상갈","청명","영통","망포","매탄권선","수원시청","매교","수원","고색","오목천","어천","야목","사리","한대앞","중앙","고잔","초지","안산","신길온천","정왕","오이도","달월","월곶","소래포구","인천논현","호구포","남동인더스파크","원인재","연수","송도","인하대","숭의","신포","인천","사당","이수","총신대입구","동작","서빙고","한남","남태령","선바위","경마공원","대공원","과천","정부과천청사","인덕원","평촌","범계","금정","군포","당정","의왕","성균관대","화서"],
  "신분당": ["신사","논현","신논현","강남","양재","양재시민의숲","청계산입구","판교","정자","미금","동천","수지구청","성복","상현","광교중앙","광교"],
  "경의중앙": ["문산","운천","임진강","금촌","금릉","파주","야당","탄현","일산","풍산","백마","곡산","능곡","행신","강매","화전","수색","디지털미디어시티","가좌","신촌","서울역","청파","효창공원앞","공덕","서강대","홍대입구","마포","신촌","용산","이촌","서빙고","한남","옥수","응봉","왕십리","청량리","회기","중랑","양원","구리","도농","양정","덕소","도심","팔당","운길산","양수","신원","국수","아신","오빈","양평","원덕","용문","지평","운정","한국항공대","월롱","망우","상봉"],
